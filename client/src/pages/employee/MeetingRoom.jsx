      ...
      <div className="card">
        ...
        {conflictInfo && (
          <div className="bg-orange-50 border border-orange-300 rounded-lg px-3 py-3 mb-3 space-y-2">
            ...
            <input className="input w-full text-sm" placeholder="סיבה לצורך בחדר ישיבות (למשל: פגישת צוות, הדרכה...)"
            ...
            <div className="flex gap-2">
              <button className="btn btn-primary text-sm" disabled={!conflictReason.trim() || submitting}
                onClick={() => book(conflictReason, conflictInfo.original_room_id)}>גרע מהחדר הרגיל ורשום לחדר ישיבות</button>
